...
Product.prototype.sell = function (quantity) {
    ...
    You can purchase up to ${this.quantity} ${this.name}s.`);
}
...
Product.prototype.getInventory = function (quantity) {
    return `We have ${this.quantity} ${this.name}s.`;
}

Product.prototype.getValue = function (quantity) {
    return `The total value of ${this.name} items is $${this.quantity * this.price}s.`;
}
